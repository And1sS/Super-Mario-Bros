...
public class Player {
	...
	public void update(Level level) {
		...
		if(Gdx.graphics.getDeltaTime() < 0.025) {
			...
			//updating X
			playerBody.setX(playerBody.getX() + playerBody.getVelocityX() * Level.SPEED * Gdx.graphics.getDeltaTime() );
			...
			//updating Y
			playerBody.setY(playerBody.getY() + playerBody.getVelocityY() * Level.SPEED * Gdx.graphics.getDeltaTime());
	...
	public void fireMario(Level level) {
	...
	public int showGameOverScreen(Level level) {
