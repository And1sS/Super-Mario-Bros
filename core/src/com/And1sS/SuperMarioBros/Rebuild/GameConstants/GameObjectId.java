...
public class GameObjectId {
    ...
    public static final int BOUNCING_BLOCK = 2;
    public static final int BROKEN_BRICK = 3;
    public static final int BROKEN_BRICK_PART = 4;
    public static final int COIN = 5;

    // Enemies from 50 to 70
    ...
    public static final int PLATFORM_TOP_DOWN = 81;
}
