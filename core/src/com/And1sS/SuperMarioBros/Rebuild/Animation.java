...
public class Animation {
    ...
    public Animation(Texture objectsTexture, int numberOfFrames,
                     int frameX, int frameY,
                     int frameWidth, int frameHeight,
                     double frameChangingSpeed,
                     boolean infinitelyRepeat) {
        ...
        if (fileLoadingSuccessful) {
            currentRegion = new TextureRegion(objectsTexture);
            currentRegion.setRegion(frameX, frameY, frameWidth, frameHeight);
        }
    }
    ...
    public Animation(Texture objectsTexture, int frameX, int frameY,
                     int frameWidth, int frameHeight) {
        this(objectsTexture, 1, frameX, frameY, frameWidth, frameHeight, 0, false);
    }
    ...
    public void setTextureX(int x) {
        bounds.set(x, bounds.getY(),
                bounds.getWidth(), bounds.getHeight());
    }

    public void setTextureY(int y) {
        bounds.set(bounds.getWidth(), y,
                bounds.getWidth(), bounds.getHeight());
    }
